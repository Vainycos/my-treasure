...
public class ElasticsearchUtil {
    ...
    public static Integer updateDataById(JSONObject jsonObject, String index, String type, String id) {
        ...
        try {
            ...
            Integer status  = client.update(updateRequest).actionGet().status().getStatus();
...
//                }
                String str =  searchHit.getSourceAsMap().get(highlightField).toString().replace(text,"<span style='background-color: yellow;'>"+text+"</span>");
